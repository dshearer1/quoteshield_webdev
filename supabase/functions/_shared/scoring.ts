...
export type ScoreInputs = {
  ...
  missing_scope_signals: number;
  pricing_outlier_signals: number;
  warranty_signals: number;
  timeline_signals: number;
};
...
function confidenceLabel(doc_quality: number, line_item_clarity: number) {
